...
<template>
  <section id="Skills" class="flex place-content-around">
    <div class="grid items-center pb-16 md:w-[80%]">
      <div class="text-2xl justify-start" data-aos="fade-right">Skills</div>
      <div class="grid md:flex place-content-around">
        ...
        >
          <div class="flex space-x-2 text-xl items-center" data-aos="fade-down">
      ...
      <div class="mt-6 text-2xl" data-aos="fade-right">Development</div>
